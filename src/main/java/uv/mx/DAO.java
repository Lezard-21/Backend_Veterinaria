...
public class DAO {
    public static List<Cliente> getAllUsuarios() {
        ...
        try {
            ...
            while (rs.next()) {
                Cliente p = new Cliente(rs.getString("id"), rs.getString("nombre"), rs.getString("pass"));
                resultado.add(p);
            }
        } catch (Exception e) {
    ...
    public static Cliente deleteUsuario(String id){
     ...
     public static Cliente GetUsuariosFromId(String id) {
        ResultSet rs = null;
        ...
        try {
            ...
            rs = preparedStatement.executeQuery();
            while (rs.next()) {
                resultado = new Cliente(rs.getString("id"), rs.getString("nombre"), rs.getString("pass"));
            }
        } catch (Exception e) {
            System.out.println(e);
        } finally {
